...
namespace usb::xhci {
    ...
    union HCCPARAMS1_Bitmap {
        ...
        struct {
            ...
            uint32_t maximum_primary_stream_array_size : 1;
            uint32_t xhci_extended_capabilities_pointer : 1;
        } __attribute__((packed)) bits;
    } __attribute__((packed));
    ...
    union USBSTS_Bitmap {
        ...
        struct {
            ...
            uint32_t controller_no_ready : 1;
    ...
    struct OperationalRegisters {
        ...
        MemMapRegister<USBCMD_Bitmap> USBSTS; 
    ...
    union PORTSC_Bitmap {
        ...
        struct {
            ...
            uint32_t port_link_status_write_strobe : 1;
